...
def process_spectral_workflow(
    data_dir,
    roi_coordinates=[(250, 247)],
    roi_width=200,
    roi_height=200,
    calpanel_coordinates=[(165, 465)],
    calpanel_width=50,
    calpanel_height=50,
    sample_pixel=(320, 340),  
    plot_rgb=False,
    ...
    """
    cp80y1, cp80x1 = 500, 200
    cp80y2, cp80x2 = 480, 180
    cp20y1, cp20x1 = 185, 480
    cp20y2, cp20x2 = 220, 500
...
#     data_dir = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/different_species/3sp/5cm'
