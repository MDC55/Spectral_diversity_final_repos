...
def process_spectral_workflow(
    data_dir,
    roi_coordinates=[(340, 340)],
    roi_width=20,
    roi_height=20,
    calpanel_coordinates=[(331, 360)],
    calpanel_width=8,
    calpanel_height=8,
    sample_pixel=(348, 345),  
    plot_rgb=False,
    ...
    # for CV calculation
    cp80y1,cp80x1 = 365,332 #y,x#row,column 
    cp80y2,cp80x2 = 363,334
    cp20y1,cp20x1 = 336,363
    cp20y2,cp20x2 = 335,365
...
#     #data_dir = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/different_species/3sp/50cm'
#     #data_dir = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/different_species/30sp_with_abundance/50cm'
