...
def visualize_chv(pixel_matrix, n_components=3, save_path=None):
    ...
    if n_components == 3:
        ...
        ax.set_title(f'3D Convex Hull in PCA Space \CHV = {volume:.4f}', fontsize=18)
...
def run_global_chv_and_cha_workflow(
    data_dirs,
    n_components=3,
...
if __name__ == "__main__":
    ...
    output_root = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/CHV_CHA_SID_SAM_5cm_results'
