...
def process_spectral_workflow(
    data_dir,
    roi_coordinates=[(300, 300)],
    roi_width=95,
    roi_height=95,
    calpanel_coordinates=[(257, 402)],
    calpanel_width=35,
    calpanel_height=35,
    sample_pixel=(320, 320),  
    plot_rgb=False,
    ...
    cp80y1, cp80x1 = 415, 265
    cp80y2, cp80x2 = 422, 272
    cp20y1, cp20x1 = 272, 418
    cp20y2, cp20x2 = 260, 425
