...
# impact_of_varying_species_2cm.py
...
def process_spectral_workflow(
    data_dir,
    roi_coordinates=[(115, 105)],
    roi_width=485,
    roi_height=485,
    calpanel_coordinates=[(10, 610)],
    calpanel_width=50,
    calpanel_height=50,
    sample_pixel=(300, 400),
    plot_rgb=False,
    ...
    """
    #All other mertics except CV
    # cp80y1, cp80x1 = 650, 50
    # cp80y2, cp80x2 = 660, 60
    # cp20y1, cp20x1 = 50, 650
    # cp20y2, cp20x2 = 60, 660
    
    # to calculate CV
    cp80y1,cp80x1 = 645,66 #y,x#row,column
    cp80y2,cp80x2 = 656,37
    cp20y1,cp20x1 = 50,650
    cp20y2,cp20x2 = 60,660
...
#     data_dir = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/different_species/3sp/2cm'
