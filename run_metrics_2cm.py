from metrics_common_without_CV import run_workflow, save_all_outputs
...
if __name__ == "__main__":
    ...
    output_root = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/CHV_CHA_SID_SAM_2cm_results'
