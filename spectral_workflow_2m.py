...
def process_spectral_workflow(
    data_dir,
    roi_coordinates=[(348, 348)],
    roi_width=4,
    roi_height=4,
    calpanel_coordinates=[(345, 352)],
    calpanel_width=3,
    calpanel_height=3,
    sample_pixel=(349, 349),  
    plot_rgb=False,
    ...
    cp80y1,cp80x1 = 353,346 #y,x#row,column
    cp80y2,cp80x2 = 353,345
    cp20y1,cp20x1 = 345,353
    cp20y2,cp20x2 = 346,353
...
#     data_dir = r'D:/Drive F 5-11-2024/A_BiosCape_Project3/Spectral_diversity/different_species/3sp/2m'
